/*
  ...
  ... then copy/pasted and modified by Ivan Ilves on Dec 23th, 2020. :)

  P.S.: Thank you Dipto and Joshi! <3
*/
...
void sing(int s) {
  ...
  if (song == 3) {
    ...
    for (int thisNote = 0; thisNote < size; thisNote++) {
      ...
      buzz(BUZZ_PIN, wish_melody[thisNote], noteDuration);
    ...
    for (int thisNote = 0; thisNote < size; thisNote++) {
      ...
      buzz(BUZZ_PIN, santa_melody[thisNote], noteDuration);
    ...
    for (int thisNote = 0; thisNote < size; thisNote++) {
      ...
      buzz(BUZZ_PIN, melody[thisNote], noteDuration);
